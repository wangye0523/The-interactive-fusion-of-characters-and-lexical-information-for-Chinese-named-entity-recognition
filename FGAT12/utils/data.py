            ...
            for line in in_lines:
                if len(line) > 3:
                    ...
                    for idx in range(w_length):
                        matched_entity = self.gaz.enumerateMatchList(word_list[idx:]) #找出句子中的词语。
                    ...
                    if count:
                        ...
                        while entitys:
                            ...
                            self.gaz_count[longest_index] = self.gaz_count.get(longest_index, 0) + 1 #记录某个词语的数量，用词语在gaz_alphabe中的索引记录
